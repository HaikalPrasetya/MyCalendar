...
import { NewEventAction } from "@/utils/actions";
...
function NewEventPage() {
  const [videoCallProvider, setVideoCallProvider] =
    useState<VideoCallType>("Google Meet");

  const [lastResult, action] = useFormState(NewEventAction, undefined);
